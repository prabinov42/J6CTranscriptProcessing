January 6 Committee Transcript Text Processing
================
Peter Rabinovitch
2023-01-05 11:24:18
...
![](J6C_v1_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](J6C_v1_files/figure-gfm/unnamed-chunk-6-3.png)<!-- -->
...
```
    ...
    ##  [1] ggraph_2.0.5       igraph_1.3.0       tesseract_5.1.0    scales_1.2.0      
    ##  [5] patchwork_1.1.1    cleanNLP_3.0.4     stringi_1.7.8      pdftools_3.0.1    
    ##  [9] wordcloud_2.6      RColorBrewer_1.1-3 tidytext_0.3.2     ggridges_0.5.3    
    ## [13] ggthemes_4.2.4     janitor_2.1.0      knitr_1.39         lubridate_1.8.0   
    ## [17] tictoc_1.0.1       forcats_0.5.1      stringr_1.4.0      dplyr_1.0.9       
    ## [21] purrr_0.3.4        readr_2.1.1        tidyr_1.2.0        tibble_3.1.7      
    ## [25] ggplot2_3.3.6      tidyverse_1.3.1   
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] fs_1.5.2           bit64_4.0.5        httr_1.4.2         SnowballC_0.7.0   
    ##  [5] tools_4.1.2        backports_1.4.1    utf8_1.2.2         R6_2.5.1          
    ##  [9] DBI_1.1.1          colorspace_2.0-3   withr_2.5.0        gridExtra_2.3     
    ## [13] tidyselect_1.2.0   bit_4.0.4          compiler_4.1.2     cli_3.4.1         
    ## [17] rvest_1.0.2        xml2_1.3.3         labeling_0.4.2     askpass_1.1       
    ## [21] rappdirs_0.3.3     digest_0.6.29      rmarkdown_2.14.1   pkgconfig_2.0.3   
    ## [25] htmltools_0.5.2    highr_0.9          dbplyr_2.1.1       fastmap_1.1.0     
    ## [29] rlang_1.0.6        readxl_1.4.0       rstudioapi_0.13    generics_0.1.2    
    ## [33] farver_2.1.1       jsonlite_1.8.0     vroom_1.5.7        tokenizers_0.2.1  
    ## [37] magrittr_2.0.3     Matrix_1.4-1       Rcpp_1.0.9         munsell_0.5.0     
    ## [41] fansi_1.0.3        viridis_0.6.2      lifecycle_1.0.3    yaml_2.3.5        
    ## [45] snakecase_0.11.0   MASS_7.3-54        plyr_1.8.6         grid_4.1.2        
    ## [49] parallel_4.1.2     ggrepel_0.9.1      crayon_1.5.1       lattice_0.20-45   
    ## [53] graphlayouts_0.7.2 haven_2.4.3        hms_1.1.1          pillar_1.7.0      
    ## [57] reprex_2.0.1       glue_1.6.2         evaluate_0.15      qpdf_1.1          
    ## [61] modelr_0.1.8       vctrs_0.5.1        tzdb_0.2.0         tweenr_1.0.2      
    ## [65] cellranger_1.1.0   gtable_0.3.0       polyclip_1.10-0    assertthat_0.2.1  
    ## [69] xfun_0.30          ggforce_0.3.3      broom_1.0.0        tidygraph_1.2.0   
    ## [73] janeaustenr_0.1.5  viridisLite_0.4.0  ellipsis_0.3.2
